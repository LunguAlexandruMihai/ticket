<div id="page-wrapper">
  <?php if($perms->g_groups_edit == "no"):?>
    <div class="row">
      <div class="alert alert-danger">
        <?php echo lang('error_groups_edit_denied');?>
      </div>
    </div>
  <?php else:?>
    <div class="row">
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="col-md-6" id="group">
                  ...
                  <?php if(isset($group_edit_success_msg) && $group_edit_success_msg == true):?>
                    <div class="alert alert-success">
                      <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                      <?php echo lang('group_edit_success_msg');?>
                    </div>
                  <?php endif;?>
                  <?php if(isset($error_group_edit_error_msg) && $error_group_edit_error_msg == true):?>
                    <div class="alert alert-danger">
                      <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                      <?php echo lang('error_group_edit_error_msg');?>
                    </div>
                  <?php endif;?>
                  <?php echo form_open('groups/edit/'.$this->uri->segment(3),array('role'=>'form','autocomplete'=>'off'));?>
                  <div class="panel panel-default">
                    <div class="panel-heading">
                      <?php echo form_input(
                        array(
                          ...
                          'value'       => set_value('g_name', $group->g_name),
                          'autofocus'
                        )
                      );
                      ?>
                    ...
                    <div class="panel-footer">
                      <?php echo form_button(
                        array(
                          ...
                          'content' => '<i class="fa fa-pencil"></i> '.lang('groups_button_edit_text')
                        )
                      );
                      ?>
                    </div>
